...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_addi.gen_multiple_test  ) , 

  # Added Tests for Hazards for other designs
  asm_test( inst_addi.gen_raw_test    ) ,
  asm_test( inst_addi.gen_waw_test    ) ,
  asm_test( inst_addi.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_andi.gen_multiple_test  ) , 

  # Added Tests for Hazards for other designs
  asm_test( inst_andi.gen_raw_test    ) ,
  asm_test( inst_andi.gen_waw_test    ) ,
  asm_test( inst_andi.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_ori.gen_multiple_test  ) ,

  # Added Tests for Hazards for other designs
  asm_test( inst_ori.gen_raw_test    ) ,
  asm_test( inst_ori.gen_waw_test    ) ,
  asm_test( inst_ori.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_xori.gen_multiple_test  ) ,

  # Added Tests for Hazards for other designs
  asm_test( inst_xori.gen_raw_test    ) ,
  asm_test( inst_xori.gen_waw_test    ) ,
  asm_test( inst_xori.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_slti.gen_multiple_test  ) ,

  # Added Tests for Hazards for other designs
  asm_test( inst_slti.gen_raw_test    ) ,
  asm_test( inst_slti.gen_waw_test    ) ,
  asm_test( inst_slti.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_sltiu.gen_multiple_test  ) ,

  # Added Tests for Hazards for other designs
  asm_test( inst_sltiu.gen_raw_test    ) ,
  asm_test( inst_sltiu.gen_waw_test    ) ,
  asm_test( inst_sltiu.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_srai.gen_multiple_test  ) ,

  # Added Tests for Hazards for other designs
  asm_test( inst_srai.gen_raw_test    ) ,
  asm_test( inst_srai.gen_waw_test    ) ,
  asm_test( inst_srai.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_srli.gen_multiple_test  ) ,

  # Added Tests for Hazards for other designs
  asm_test( inst_srli.gen_raw_test    ) ,
  asm_test( inst_srli.gen_waw_test    ) ,
  asm_test( inst_srli.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_slli.gen_multiple_test  ) ,

  # Added Tests for Hazards for other designs
  asm_test( inst_slli.gen_raw_test    ) ,
  asm_test( inst_slli.gen_waw_test    ) ,
  asm_test( inst_slli.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  # Added Tests for Hazards for other designs
  asm_test( inst_lui.gen_waw_test    ) ,
  asm_test( inst_lui.gen_war_test    ) ,
])
...
@pytest.mark.parametrize( "name,test", [
  ...
  # Added Tests for Hazards for other designs
  asm_test( inst_auipc.gen_waw_test    ) ,
  asm_test( inst_auipc.gen_war_test    ) ,
])
